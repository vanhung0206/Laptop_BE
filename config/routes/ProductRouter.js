...
var productUpload = upload.fields([{ name: 'image', maxCount: 1 }, { name: 'listimage', maxCount: 8 }])

Router.get("/products",ProductController.getProduct);  //get product by search or get all product
Router.get("/admin/products",Authentication.isAdmin,ProductController.getAllProduct);  //get product by search or get all product
...
Router.post("/product",productUpload,Authentication.isAdmin,ProductController.createProduct);
Router.put("/product",productUpload,Authentication.isAdmin,ProductController.updateProduct);
